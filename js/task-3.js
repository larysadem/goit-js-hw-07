...
// операцию вставки.Добавь минимальное оформление
// галереи флексбоксами или гридами через css - классы.
...
const listItems = ({ url, alt }) => {
    return `<li class="gallery-item"><img src='${url}' alt='${alt}' class="gallery-img"></li>`;
};

const сreateGallery = images.map(listItems).join('');
list.insertAdjacentHTML('beforeend', сreateGallery);
